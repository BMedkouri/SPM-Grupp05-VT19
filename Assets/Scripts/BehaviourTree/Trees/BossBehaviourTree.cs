...
public class BossBehaviourTree : BehaviourTree
{
    ...
    /// <summary>
    /// Starts a special scene if the boss dies, also disable the enemy when it dies.
    /// </summary>
    ...
    /// <summary>
    /// Not in use at the moment. If the GameMangers starts to work again, we might use it.
    /// </summary>
