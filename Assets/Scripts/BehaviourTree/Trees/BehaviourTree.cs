...
public abstract class BehaviourTree : MonoBehaviour
{
    ...
    protected void Awake()
    {
        ...
        GameManager.Enemies.Add(id, this);
    }
    ...
    /// <summary>
    /// as the method says, creates a behaviour.
    /// </summary>
    ...
    /// <summary>
    /// makes the dark aoe available again after 10-20 seconds
    /// </summary>
    ...
    /// <summary>
    /// this script turnes off the enemy when it dies
    /// </summary>
